...
$jumlah=$koneksi->query("SELECT * FROM pembelian_produk WHERE id_pembelian='$idpem'");

$detpem=$ambil->fetch_assoc();
$jumlah_barang=$jumlah->fetch_assoc();
...
<body>
	...
	<div class="container">
		...
		<form method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
				<label>Jumlah</label>
				<input type="number" name="jumlah" class="form-control" min="1" placeholder="jumlah barang" value="<?= $jumlah_barang["jumlah"] ?>" readonly>
			</div>
			<div class="form-group">
