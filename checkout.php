	...
	<div class="container">
		...
		<form method="post">
			...
			<div class="row">
				...
				<input type="text"  name="nama_pembeli" placeholder="Masukan Nama Pembeli" class="form-control" required>
			</div></div>
				<div class="col-md-4"><div class="form-group">
				<label>No Telphone</label>
				<input type="text"  name="no_telp" placeholder="Masukkan Nomor Telepon Pembeli" class="form-control" required>
			</div></div>
			<div class="col-md-4"><div class="form-group">
				<label>Alamat Email</label>
				<input type="text"  name="email_pembeli" placeholder="Masukkan Alamat Email" class="form-control" required>
			</div></div>
			<div class="col-md-4"><div class="form-group">
		...
		?>
			...
			<div class="col-md-15"><div class="form-group">
				...
				<input type="text" name="biaya" id="biaya" placeholder="Biaya" class="form-control" readonly>
			</div></div>
		...
		<?php if (isset($_POST["checkout"])) 
		{
			...
			$_SESSION['checkout_keranjang'] = $_POST["data_checkout"];
